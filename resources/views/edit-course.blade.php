...
@section('adminpage')
    ...
    <div class="form-col">
        ...
        <div class="col-md-12 m-auto">
            <form id="service-form" class="create-form" method='post' action="{{url('/update-course/' . $course->id)}}">
                @csrf
                <div class="row gx-0">
                            ...
                            <fieldset>
                                ...
                                <div class="row"> 
                                    <div class="col-md-12">
                                        ...
                                        <input name="course_name" id="course" type="text" required value="{{$course->course_name }}">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="duration" id="duration" type="number" required value="{{$course->duration}}">
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="lab_number" id="lab_number" required>
                                            ...
                                            @foreach ($labs as $lab)
                                                <option value="{{ $lab->id }}" {{ ($lab->id == $course->lab_number) ? 'selected' : '' }}>
                                                    {{ $lab->lab_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        @php
                                        $seats = \App\Models\Batch::where('lab_id', $course->lab_number)->sum('pending_seats');
                                    @endphp
                                        
                                        <label for="">Total Seats<sup>*</sup></label>
                                        <input name="seats" id="seats" type="number" readonly value="{{$seats}}">
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#lab_number').change(function() {
            ...
            $.ajax({
                // url: '/get-lab-details/' + labNumber, 
                url: '{{ url("/get-lab-details") }}'+ '/' + labNumber,
                method: 'GET',

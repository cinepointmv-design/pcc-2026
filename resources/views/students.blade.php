                                            ...
                                            <tr class="client-row">
                                                <td>
                                                    ...
                                                    <td>
                                                        @foreach($student->studentCourses as $course)
                                                            @php
                                                                $totalDuration += $course->course->duration; // Add duration to total
                                                            @endphp
                                                        @endforeach
                                                    
                                                        @php
                                                            $startDate = now(); // Assuming start date is current date
                                                            $endDate = $startDate->copy()->addMonths($totalDuration); // Calculate end date
                                                            $courseCompleted = $endDate->isPast(); // Check if end date is in the past
                                                        @endphp
                                                ...
                                                {{-- </td>
                                                <td> --}}
                                                    <a class="edit-btn" href="{{url('/view-students/' . $student->id )}}">

...
@section('page')
            <!-- table section -->
            <form action="{{url('/remove-service')}}" method="post" >
                @csrf
            <div class="table-col">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 row align-items-center heading-wrapper">
                            ...
                            <div class="col-md-6 col-12">
                                <a href="{{url('/add-service')}}" class="btn d-block ms-md-auto ms-none">New Service</a>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="dropdown profile-dropdown delete-dropdown" id="delete-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <button class="dropdown-item" href="{{url('/remove-service')}}" onclick="return confirmDelete();">
                                ...
                                <div class="table-container">
                                    <table class="table table-hover data-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="selected_service[]" class="select-checkbox" value="{{ $services->id }}">
                                                </td>
                                                    <td>{{ $services->name }} </td>
                                                    <td>{{ $services->price }} </td>
                                                  
                                                <td>
                                                    <a class="edit-btn" href="{{url('/edit-service/' . $services->id)}}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                            fill="currentColor" aria-hidden="true">
                                                            <path

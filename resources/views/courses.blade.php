...
@section('adminpage')
            <!-- table section -->
            <form action="{{url('/remove-course')}}" method="post" >
                @csrf
            <div class="table-col">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 row align-items-center heading-wrapper">
                            ...
                            <div class="col-md-6 col-12">
                                <a href="{{url('/add-course')}}" class="btn d-block ms-md-auto ms-none">Add Course</a>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="dropdown profile-dropdown delete-dropdown" id="delete-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <button class="dropdown-item" href="{{url('/remove-course')}}" onclick="return confirmDelete();">
                                ...
                                <div class="table-container">
                                    <table class="table table-hover data-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="selected_course[]" class="select-checkbox" value="{{ $course->id }}">
                                                </td>
                                                    ...
                                                    @php
                                                        $labdata = \App\Models\Lab::where('id', $course->lab_number)->get();
                                                    @endphp
                                                    ...
                                                    @php
                                                    $studentCount = \App\Models\StudentCourse::where('course_id', $course->id)->count();
                                                @endphp
                                               
                                                    <td>{{$studentCount}}</td>
                                                   
                                                <td>
                                                    <a class="edit-btn" href="{{url('/edit-course/' . $course->id)}}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                            fill="currentColor" aria-hidden="true">
                                                            <path

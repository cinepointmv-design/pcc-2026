...
@section('adminpage')
    ...
    <div class="alert alert-danger mt-4 alert-dismissible fade show slide-from-right auto-dismiss" style="display: none" role="alert" >
        <p class="alertmessage " style="font: 18px;"></p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 m-auto">
                            ...
                            <form action="" method="post" class="create-form" id="payment-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" required name="total_fees"  id="total-price" >
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="">Paybale Fees (In Rupees)</label>
                                        <input type="number" required name="total-paid-fees"  id="total-paid-fees" >
                                    </div>

                                    <div class="col-md-6">
                                        <label for="">Pending Fees (In Rupees)</label>
                                        <input type="number" required name="pending-fees"  id="pending-fees" >
                                    </div>
                            ...
                            <!-- Hidden input field to store simulated payment data -->
                             <input type="hidden" id="simulated-payment-data" name="simulated_payment_data">
...
$(document).ready(function() {
        ...
        $(".auto-dismiss").delay(3000).fadeOut("slow");
    });
...
function calculatePendingFees() {
    ...
    if (!isNaN(totalPaidFees) && totalPaidFees <= totalFees) {
        ...
        document.getElementById('pending-fees').value = "";
    }
}
...
document.getElementById('fees').addEventListener('input', calculatePendingFees);
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.error) {
               $('.alert.alert-danger .alertmessage').text(response.error);
               $('.alert.alert-danger').show(); // Display the alert div
            } else {
                // If no error, clear the error div and redirect to the next page
...
document.getElementById('simulate-payment-button').addEventListener('click', function (event) {
    ...
    if (validateForm()) {
        ...
        alert('Student register successfully'); // Show the alert

                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 m-auto">
                            ...
                            // dd($storedServices); // Uncomment to verify the stored services
                            @endphp
                            ...
                            <form action="{{ url('/create-client-4') }}" method="post" class="create-form">
                                ...
                                @if(is_array($storedServices) && count($storedServices) > 0)
                                    @foreach ($storedServices as $serviceData)
                                        <div class="row">
                                            <!-- Display service details for each stored service -->
                                            <div class="col-md-6">
